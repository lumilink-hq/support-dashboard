// Marketing landing page — PARKED AT /preview.
//
// This is the Next.js candidate for the public site. The Wix site is still the
// real front door, so this lives at /preview rather than "/" until someone
// decides to switch. "/" is back to redirecting into the dashboard.
//
// To promote it: move this file to app/page.tsx, delete the redirect that's
// there now, swap "/preview" for "/" in lib/route-access.ts (PUBLIC_EXACT),
// update scripts/test-route-access.ts, drop the `robots` block below, and pass
// nothing for MarketingShell's homeHref so the wordmark points at "/".
//
// REACHABLE BY ANYONE WITH THE LINK, BUT NOT INDEXED. The robots metadata below
// is what stops Google ranking this alongside the Wix site — two competing
// pages for one brand splits the signal and neither wins. Keep it until this
// page IS the site.
//
...
export const metadata: Metadata = {
  ...
  // Remove this once /preview becomes the live site.
...
export default function LandingPage() {
  return (
    // homeHref keeps the wordmark on this page while it's parked; without it
    // clicking the logo would bounce you into the dashboard.
    <MarketingShell homeHref="/preview">
      {/* ---------------------------------------------------------------- */}
      {/* Hero                                                             */}
      {/* ---------------------------------------------------------------- */}
